...
def load_vgg(sess, vgg_path):
    ...
    image_inp = graph.get_tensor_by_name(vgg_input_tensor_name)
    keep_prb = graph.get_tensor_by_name(vgg_keep_prob_tensor_name)
    ...
    return image_inp, keep_prb, l3_out, l4_out, l7_out
...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    layer7_upsampling = tf.layers.conv2d_transpose(layer7_conv_1x1,num_classes,4,strides=(2,2),padding='same',kernel_regularizer = tf.contrib.layers.l2_regularizer(1e-3))
